          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pb-2">
            ...
            <div className="lg:col-span-4 flex flex-col items-start gap-4">
              <Link href="/" onClick={handleLogoClick} className="inline-block transition-opacity hover:opacity-90">
                <span className="font-[family-name:var(--font-chillax)] text-3xl font-[700] tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-[#F4F4EC] to-neutral-600">
                  Zenlio
                </span>
              </Link>
              ...
              <div className="flex items-center gap-4 mt-2">
                <a href="https://twitter.com/zenlio" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-primary transition-colors" aria-label="Twitter/X">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 22.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </a>
                <a href="https://linkedin.com/company/zenlio" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-primary transition-colors" aria-label="LinkedIn">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
