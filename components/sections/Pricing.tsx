                    ...
                    {addonsExpanded && (
                      <>
                        ...
                        <motion.div 
                          ...
                          className="absolute left-0 right-0 top-[110%] z-[60] bg-background/60 backdrop-blur-xl border border-border/40 rounded-[24px] shadow-lg shadow-black/10 max-h-60 overflow-y-auto custom-scrollbar p-3"
