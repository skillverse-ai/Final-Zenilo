                    ...
                    {addonsExpanded && (
                      <>
                        ...
                        <motion.div 
                          ...
                          className="absolute left-0 right-0 top-[110%] z-[60] bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[24px] shadow-2xl max-h-60 overflow-y-auto custom-scrollbar p-3"
